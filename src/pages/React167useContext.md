Again, we using the Theme Context with the new React APIs: useContext. It will be a shorthand to use context inside function components
...
const ThemeConsumer = () => {
    ...
    const { bgColor, fgColor, changeTheme } = themeContext;
